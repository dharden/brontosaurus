...
var World = function World(callback) {
    ...
    var world = this;
    var CASPER_PORT = 8081;
    var spooky, casper;

    // XXX: You are here. Create some fixture pages. /1-3 at a minimum.
    // Then add httpserver as a dependency and write a makefile
    this.testUrl = 'http://spookytests:8888';

    this.errors = [];
    if (casper) {
        capser.unlisten(CASPER_PORT);
    }
